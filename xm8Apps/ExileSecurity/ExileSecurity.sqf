...
_display = uiNameSpace getVariable ["RscExileXM8", displayNull];
  ...
  _ctrlArray = [4000,4001,4007,4060,4040,4120,4080,4070,4090,4100,4110,4130,4030];
...
disableSerialization;
  ...
  _display = uiNameSpace getVariable ["RscExileXM8", displayNull];
  _AppsArray = [6001,6000,5003,5004,5005,5006];
  {
      _ctrl = (_display displayCtrl _x);
      _ctrl ctrlSetFade 1;
      _ctrl ctrlCommit 0.25;
...
_TerritoryDropDown = _display ctrlCreate ["RscCombo", 6000];
